...
var jscolor = {
	...
	dir: '', // location of colorSetting directory (leave empty to autodetect)
	bindClass: 'color', // class name
	binding: true, // automatic binding via <input class="...">
	preloading: true, // use img preloading?
	...
	getDir: function () {
		if (!jscolor.dir) {
			...
			jscolor.dir = detected !== false ? detected : 'colorSetting/';
		}
		return jscolor.dir;
	},
	...
	/*
	 * Usage example:
	 * var myColor = new colorSetting.color(myInputElement)
	 */
	...
	color: function (target, prop) {
		...
		function drawPicker(x, y) {
			...
			p.padM.style.background = "url('" + jscolor.getDir() + "img/cross.gif') no-repeat";
			p.sldM.style.background = "url('" + jscolor.getDir() + "img/arrow.gif') no-repeat";
